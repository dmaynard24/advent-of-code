...
def shuttle_search(notes):
  earliest_time, bus_ids = notes.split('\n')
  earliest_time, bus_ids = int(earliest_time), bus_ids.split(',')

  max_decimal_remainder = -sys.maxsize
  closest_bus_id = None
  for bus_id in bus_ids:
    if bus_id == 'x':
      continue
    int_bus_id = int(bus_id)
    decimal_remainder = earliest_time / int_bus_id - earliest_time // int_bus_id
    if decimal_remainder > max_decimal_remainder:
      max_decimal_remainder = decimal_remainder
