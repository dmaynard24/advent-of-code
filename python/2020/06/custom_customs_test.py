import unittest, custom_customs


class TestCustomCustoms(unittest.TestCase):
  def test_custom_customs(self):
    self.assertEqual(custom_customs.custom_customs('''abc
...
b'''), 11)
  ...
  def test_custom_customs_1(self):
    self.assertEqual(
        custom_customs.custom_customs('''gyrf
idg
...
fbmtw'''), 6_521)
  ...
  def test_custom_customs_part_2(self):
    self.assertEqual(custom_customs.custom_customs_part_2('''abc
...
b'''), 6)
  ...
  def test_custom_customs_part_2_1(self):
    self.assertEqual(
        custom_customs.custom_customs_part_2('''gyrf
idg
