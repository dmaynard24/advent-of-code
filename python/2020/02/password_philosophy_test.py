import unittest, password_philosophy


class TestPasswordPhilosophy(unittest.TestCase):
  def test_password_philosophy(self):
    self.assertEqual(
        password_philosophy.password_philosophy('''1-3 a: abcde
1-3 b: cdefg
2-9 c: ccccccccc'''), 2)

  def test_password_philosophy_1(self):
    self.assertEqual(
        password_philosophy.password_philosophy('''2-4 p: vpkpp
...
4-5 s: rsssw
2-14 c: jckbwnnlkcmvnwtj'''), 474)

  def test_password_philosophy_part_2(self):
    self.assertEqual(
        password_philosophy.password_philosophy_part_2('''1-3 a: abcde
1-3 b: cdefg
2-9 c: ccccccccc'''), 1)

  def test_password_philosophy_part_2_1(self):
    self.assertEqual(
        password_philosophy.password_philosophy_part_2('''2-4 p: vpkpp
6-16 b: bbbbbbbbbbbbbbbpb
6-7 z: zzfzzdz
4-6 q: tfzqvqcpcmqqjqzd
7-8 k: rkkkknkw
