import unittest, handy_haversacks


class TestHandyHaversacks(unittest.TestCase):
  def test_handy_haversacks(self):
    self.assertEqual(
        handy_haversacks.handy_haversacks('''light red bags contain 1 bright white bag, 2 muted yellow bags.
...
dotted black bags contain no other bags.'''), 4)
  ...
  def test_handy_haversacks_1(self):
    self.assertEqual(
        handy_haversacks.handy_haversacks('''light plum bags contain 1 faded blue bag.
...
pale tan bags contain 5 posh gray bags, 3 wavy violet bags.'''), 326)

  def test_handy_haversacks_part_2(self):
    self.assertEqual(
        handy_haversacks.handy_haversacks_part_2('''shiny gold bags contain 2 dark red bags.
...
dark violet bags contain no other bags.'''), 126)
  ...
  def test_handy_haversacks_part_2_1(self):
    self.assertEqual(
        handy_haversacks.handy_haversacks_part_2('''light plum bags contain 1 faded blue bag.
muted salmon bags contain 4 faded lavender bags, 4 posh magenta bags.
wavy gray bags contain 2 dotted teal bags.
wavy tan bags contain 2 plaid aqua bags.
wavy purple bags contain 1 drab white bag, 4 muted yellow bags, 2 wavy aqua bags.
...
vibrant red bags contain 1 dotted indigo bag, 2 faded beige bags, 1 drab tomato bag.
striped maroon bags contain 3 plaid aqua bags, 2 dim maroon bags, 4 plaid chartreuse bags.
pale tan bags contain 5 posh gray bags, 3 wavy violet bags.'''), 5_635)
