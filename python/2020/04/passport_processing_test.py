import unittest, passport_processing


class TestPassportProcessing(unittest.TestCase):
  def test_passport_processing(self):
    self.assertEqual(
        passport_processing.passport_processing('''ecl:gry pid:860033327 eyr:2020 hcl:#fffffd
...
iyr:2011 ecl:brn hgt:59in'''), 2)
  ...
  def test_passport_processing_1(self):
    self.assertEqual(
        passport_processing.passport_processing('''ecl:grn
...
ecl:#ae12d3 hgt:74cm cid:239 hcl:z pid:345439730 iyr:1924 byr:2029 eyr:2031'''), 226)

  def test_passport_processing_part_2(self):
    self.assertEqual(
        passport_processing.passport_processing_part_2('''ecl:gry pid:860033327 eyr:2020 hcl:#fffffd
byr:1937 iyr:2017 cid:147 hgt:183cm
...
iyr:2011 ecl:brn hgt:59in'''), 2)
  ...
  def test_passport_processing_part_2_1(self):
    self.assertEqual(
        passport_processing.passport_processing_part_2('''ecl:grn
cid:315 iyr:2012 hgt:192cm eyr:2023 pid:873355140 byr:1925 hcl:#cb2c03
...
ecl:#ae12d3 hgt:74cm cid:239 hcl:z pid:345439730 iyr:1924 byr:2029 eyr:2031'''), 160)

  def test_passport_processing_part_2_2(self):
    self.assertEqual(
        passport_processing.passport_processing_part_2('''eyr:1972 cid:100
...
pid:3556412378 byr:2007'''), 0)
  ...
  def test_passport_processing_part_2_3(self):
    self.assertEqual(
        passport_processing.passport_processing_part_2('''pid:087499704 hgt:74in ecl:grn iyr:2012 eyr:2030 byr:1980
hcl:#623a2f
