...
4'''), 1_890)
  ...
  def test_adapter_array_part_2(self):
    self.assertEqual(adapter_array.adapter_array_part_2('''16
10
15
5
1
...
4'''), 8)
  ...
  def test_adapter_array_part_2_1(self):
    self.assertEqual(
        adapter_array.adapter_array_part_2('''28
33
18
42
31
...
3'''), 19_208)
  ...
  def test_adapter_array_part_2_2(self):
    self.assertEqual(
        adapter_array.adapter_array_part_2('''70
102
148
9
99
